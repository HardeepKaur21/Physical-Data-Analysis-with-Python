...
lastLength = 0 #now we do not know pi, the previous length will be used to 
#calculate the error
...
while c_error > 1e-6:
    ...
    #assuming the larger n is the more accuracy we get so the error is gonna be 
    #the calculated length minus the previously calculate length 
    c_error = c_length - lastLength
    ...
    lastLength = c_length #set lastLength to c_length before the code reset it    
